...
export const Projects: React.FC<{ basePath: string; lang: string }> = ({
  ...
  return (
    <div className="w-full min-h-full sm:p-4 text-white">
    ...
    -translate-x-1/2 translate-y-full opacity-0 m-4 mx-auto"
            ...
            <div className="w-4/5 sm:w-1/2 sm:mt-0 mt-4 relative outline-dashed outline-2 outline-pallete4c rounded-lg overflow-visible">
              <img
